...
const Sell = () => {
    ...
    if (!isLoggedIn()) {
        return (
            <div className="notSignedInBlock">
                <p className = "signInNotif">You must be signed in to sell a book.</p>
                <Link to="/login">
                    <Button style={btnStyle2} to="/login">Log In</Button>
                </Link>
                <Link to="/register">
                    <Button style={btnStyle2} to="/register"> Sign Up</Button>
                </Link>
